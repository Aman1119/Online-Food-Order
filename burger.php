...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-sm-6">
			...
			<h1 class="headd">burger</h1><br>
			<h5 class="headd3">Note:- Default burger is of Rs.80 with single aloo patty, tomato, and onion.</h5>
			<div style="background-color: rgba(255,255,255,0); height: 20px;">
			</div>
			...
			<form action="#" method="post">
				<div class="row">
					<div class="col-sm-12">
						<div class="form-group">
							<label class="headd2">Select Ingredients</label><br>
							<label class="headd3">* On every ingredient adding Rs.25 will be charged.</label>
						</div>
					</div>
				</div>
				<div class="row">
				...
				<div class="row">
					<div class="col-sm-4 topp">
						<input type="checkbox" name="topping[]" value="Cheese Jalapeno"><label class="headd1">&nbsp;&nbsp;cheese jalapeno</label>
					</div>
					<div class="col-sm-4 topp">
						<input type="checkbox" name="topping[]" value="Chicken Tikka"><label class="headd1">&nbsp;&nbsp;chicken tikka</label>
					</div>
					<div class="col-sm-4 topp">
						<input type="checkbox" name="topping[]" value="+1 Aloo Patty"><label class="headd1">&nbsp;&nbsp;+1 Aloo patty</label>
					</div>
				</div><br>
				<div class="row">
					<div class="col-sm-9">

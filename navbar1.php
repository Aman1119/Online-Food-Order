		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav" style="margin-left: 30%;">
					<li class="ss"><a href="./home.php" class="upp">about us</a></li>
					<li class="ss"><a href="./home.php" class="upp">menu</a></li>
								...
								<div class="row dmenu">
									<div class="col-sm-12">
										...
										<ul class="nav navbar-nav" style="width: 100%;">
											...
											<li class="ss3"><a class="menuaa upp" href="cart.php">Cart <span class="badge">'.$rowcount.'</span></a></li><br>
										</ul>
									</div>
								</div>
							</li>
